    ...
    Ext.apply(Ext.ensible, {
        ...
        Date: {
            ...
            diffDays: function (e, a) {
                var b = 1000 * 60 * 60 * 24,
                    c = a.clearTime(true).getTime() - e.clearTime(true).getTime();
...
if (Ext.DomHelper) {
    Ext.apply(
        ...
        (function () {
            var x = null,
                l = /^(?:br|frame|hr|img|input|link|meta|range|spacer|wbr|area|param|col)$/i,
                n = /^table|tbody|tr|td$/i,
                e = /tag|children|cn|html$/i,
                t = /td|tr|tbody/i,
                p = /([a-z0-9-]+)\s*:\s*([^;\s]+(?:\s*[^;\s]+)*);?/gi,
                v = /end/i,
                s,
                o = 'afterbegin',
                q = 'afterend',
            ...
            s = {
                ...
                insertHtml: function (D, y, E) {
                    ...
                    if (y.insertAdjacentHTML) {
                        if (n.test(y.tagName) && (z = f(y.tagName.toLowerCase(), D, y, E))) {
                            return z;
                        }
                        ...
                        if (C[D]) {
                            ...
                            if (F.createContextualFragment) {
                                ...
                                (I = document.createDocumentFragment()), (H = document.createElement('div'));
                                I.appendChild(H);
                                H.outerHTML = E;
                            }
                            y.parentNode.insertBefore(I, D == c ? y : y.nextSibling);
...
Ext.ensible.cal.DayHeaderTemplate = function (a) {
    ...
    Ext.ensible.cal.DayHeaderTemplate.superclass.constructor.call(
        this,
...
Ext.ensible.cal.DayHeaderTemplate.prototype.apply =
    Ext.ensible.cal.DayHeaderTemplate.prototype.applyTemplate;
Ext.ensible.cal.DayBodyTemplate = function (a) {
    Ext.apply(this, a);
    Ext.ensible.cal.DayBodyTemplate.superclass.constructor.call(
        this,
...
Ext.extend(Ext.ensible.cal.DayBodyTemplate, Ext.XTemplate, {
    applyTemplate: function (e) {
        ...
        var a = [],
            b = this.viewStartHour,
            g = this.viewEndHour,
            c = this.hourIncrement,
            k = this.hourHeight * (g - b);
        ...
        return Ext.ensible.cal.DayBodyTemplate.superclass.applyTemplate.call(this, {
            ...
            hourSeparatorCls: this.showHourSeparator ? '' : 'no-sep',
            dayHeight: k,
            hourSeparatorHeight: this.hourHeight / 2 - 1,
        });
    },
});
Ext.ensible.cal.DayBodyTemplate.prototype.apply =
    Ext.ensible.cal.DayBodyTemplate.prototype.applyTemplate;
Ext.ensible.cal.BoxLayoutTemplate = function (a) {
    Ext.apply(this, a);
    var b = this.showWeekLinks
...
Ext.extend(Ext.ensible.cal.BoxLayoutTemplate, Ext.XTemplate, {
    ...
    applyTemplate: function (n) {
        ...
        var k = 0,
            ...
            b = n.todayCls,
            g = [[]],
            r = new Date().clearTime(),
            l = this.viewStart.clone(),
            c = this.startDate.getMonth();
        for (; k < this.weekCount || this.weekCount == -1; k++) {
            ...
            for (var q = 0; q < this.dayCount; q++) {
                ...
                m = l.getDay() % 6 === 0;
                if (l.getDay() == 1) {
                    g[k].weekNum = this.showWeekNumbers ? l.format('W') : '&#160;';
                    g[k].weekLinkId = 'ext-cal-week-' + l.format('Ymd');
                }
                if (h) {
                    if (v) {
                        u = this.getTodayText();
        ...
        return Ext.ensible.cal.BoxLayoutTemplate.superclass.applyTemplate.call(this, {weeks: g});
    },
...
Ext.ensible.cal.MonthViewTemplate = function (a) {
    ...
    Ext.ensible.cal.MonthViewTemplate.superclass.constructor.call(
        this,
...
Ext.extend(Ext.ensible.cal.MonthViewTemplate, Ext.XTemplate, {
    ...
    applyTemplate: function (g) {
        ...
        for (var b = 0; b < 7; b++) {
            ...
            h.push({name: f.format(this.dayHeaderFormat), title: f.format(this.dayHeaderTitleFormat)});
        }
...
Ext.ensible.cal.MonthViewTemplate.prototype.apply =
    Ext.ensible.cal.MonthViewTemplate.prototype.applyTemplate;
Ext.dd.ScrollManager = (function () {
    ...
    var g = function (n, m) {
        ...
        i.dir = m;
        var p =
                n.ddScrollConfig && n.ddScrollConfig.frequency
...
Ext.ensible.cal.StatusProxy = function (a) {
    ...
    this.el = new Ext.Layer({
        dh: {
            ...
            cn: [
                {cls: 'x-dd-drop-icon'},
                {cls: 'ext-dd-ghost-ct', cn: [{cls: 'x-dd-drag-ghost'}, {cls: 'ext-dd-msg'}]},
            ],
        },
...
Ext.ensible.cal.DropZone = Ext.extend(Ext.dd.DropZone, {
    ...
    onNodeOver: function (f, l, k, h) {
        var a = Ext.ensible.Date,
            ...
            g =
                h.type == 'eventdrag'
                    ? f.date.add(Date.DAY, a.diffDays(h.eventStart, h.eventEnd))
        ...
        if (
            ...
            this.dragEndDate = g.clearTime().add(Date.DAY, 1).add(Date.MINUTE, -30);
            this.shim(b, g);
    ...
    shim: function (a, f) {
        ...
        var b = a.clone(),
            ...
            e,
            h,
            c = Ext.ensible.Date.diffDays(b, f) + 1;
    ...
    createShim: function () {
        ...
        return new Ext.Layer({shadow: false, useDisplay: true, constrain: false}, b);
    },
    clearShims: function () {
...
Ext.ensible.cal.DayViewDropZone = Ext.extend(Ext.ensible.cal.DropZone, {
    ...
    onNodeOver: function (c, p, m, i) {
        var b,
            q = this.createText,
            h = Ext.ensible.Date.use24HourTime ? 'G:i' : 'g:ia';
        if (i.type == 'caldrag') {
            ...
            var l,
                k = this.dragStartMarker.getBox();
            k.height = Math.ceil(Math.abs(m.xy[1] - k.y) / c.timeBox.height) * c.timeBox.height;
            if (m.xy[1] < k.y) {
                k.height += c.timeBox.height;
                k.y = k.y - k.height + c.timeBox.height;
                l = this.dragCreateDt.add(Date.MINUTE, this.ddIncrement);
            } else {
                c.date = c.date.add(Date.MINUTE, this.ddIncrement);
            }
            this.shim(this.dragCreateDt, k);
            var o = Ext.ensible.Date.diff(this.dragCreateDt, c.date),
                t = this.dragCreateDt.add(Date.MILLI, o);
            this.dragStartDate = Ext.ensible.Date.min(this.dragCreateDt, t);
            this.dragEndDate = l || Ext.ensible.Date.max(this.dragCreateDt, t);
            b = String.format(
            ...
            if (i.type == 'eventresize') {
                ...
                var o = Ext.ensible.Date.diff(this.resizeDt, c.date),
                    t = this.resizeDt.add(Date.MILLI, o),
                    a = Ext.ensible.Date.min(i.eventStart, t),
                    g = Ext.ensible.Date.max(i.eventStart, t);
                i.resizeDates = {StartDate: a, EndDate: g};
                b = String.format(this.dateRangeFormat, a.format(h), g.format(h));
                q = this.resizeText;
            }
        }
...
Ext.ensible.cal.CalendarRecord.reconfigure = function () {
    var f = Ext.ensible.cal,
        g = f.CalendarMappings,
        e = f.CalendarRecord.prototype,
        b = [];
    for (prop in g) {
        if (g.hasOwnProperty(prop)) {
            b.push(g[prop]);
...
Ext.ensible.cal.WeekEventRenderer = (function () {
    ...
    var b = function (g, n, e, f, c, i, h) {
        var m = Ext.ensible.cal.EventMappings,
            p = g.data || g.event.data,
            q = i.clone(),
            r = q.add(Date.DAY, c - e).add(Date.MILLI, -1),
            k = a(h.viewId, n, f),
            o = Ext.ensible.Date.diffDays(i, p[m.EndDate.name]) + 1,
            l = Math.min(o, c - e);
        p._weekIndex = n;
        ...
        p.spanCls = p.spanLeft
            ...
            : p.spanRight
                ...
                : '';
        var s = {tag: 'td', cls: 'ext-cal-ev', cn: h.tpl.apply(h.templateDataFn(p))};
        if (l > 1) {
            s.colspan = l;
        }
    ...
    return {
        render: function (w) {
            var y = this,
                ...
                n = '',
                o = w.tpl,
                r = w.maxEventsPerDay != undefined ? w.maxEventsPerDay : 999,
                u = w.weekCount < 1 ? 6 : w.weekCount,
                p = w.weekCount == 1 ? w.dayCount : 7,
                v,
                q,
                c,
                g,
                    ...
                    if (c && c[q]) {
                        ...
                        if (h > 0) {
                            ...
                            Ext.DomHelper.append(v, {
                                ...
                                cn: {tag: 'a', html: String.format(w.getMoreText(h), h)},
                            });
                        } else {
                        ...
                        v = a(w.viewId, t, 0);
                        if (v) {
                            l = {tag: 'td', cls: 'ext-cal-ev', html: z, id: w.viewId + '-empty-day-' + n};
...
Ext.ensible.cal.CalendarCombo = Ext.extend(Ext.form.ComboBox, {
    ...
    initComponent: function () {
        var a = Ext.ensible.cal,
            b = a.CalendarMappings;
    ...
    setValue: function (a) {
        ...
        Ext.ensible.cal.CalendarCombo.superclass.setValue.call(this, a);
    ...
    onRender: function (b, a) {
        if (!this.el) {
            this.frequencyCombo = new Ext.ensible.cal.RecurrenceCombo({
                ...
                listeners: {recurrencechange: {fn: this.showOptions, scope: this}},
            });
            if (this.fieldLabel) {
                this.frequencyCombo.fieldLabel = this.fieldLabel;
            }
            this.innerCt = new Ext.Container({cls: 'extensible-recur-inner-ct', items: []});
        ...
        Ext.ensible.cal.RecurrenceField.superclass.onRender.call(this, b, a);
    },
    initValue: function () {
    ...
    initSubComponents: function () {
        Ext.ensible.cal.recurrenceBase = Ext.extend(Ext.Container, {
            ...
            initNthCombo: function (i) {
                var i = Ext.getCmp(this.id + '-combo'),
                    b = this.startDate,
                    n = i.getStore(),
                    o = b.getLastDateOfMonth().getDate(),
                    c = b.getDate(),
                    p = b.format('jS') + ' day',
                    h = this.id.indexOf('-yearly') > -1,
                    l = ' in ' + b.format('F'),
                    g,
                    e,
                    k,
                    ...
                    q;
                g = Math.ceil(c / 7);
                e = g + this.getSuffix(g) + b.format(' l');
                if (h) {
                    p += l;
                    e += l;
                }
        ...
        this.repeatEvery = new Ext.ensible.cal.recurrenceBase({
            ...
            updateLabel: function (b) {
                if (this.rendered) {
                    ...
                    if (c.rendered) {
                        c.update(this.type + a + ' beginning ' + this.startDate.format('l, F j'));
                    }
                }
                return this;
            },
        ...
        this.weekly = new Ext.ensible.cal.recurrenceBase({
            ...
            selectToday: function () {
                this.clearValue();
                var a = this.startDate.format('D').substring(0, 2).toUpperCase();
            ...
            getValue: function () {
                var b = '',
                    c = Ext.getCmp(this.id + '-days').getValue();
        ...
        this.monthly = new Ext.ensible.cal.recurrenceBase({
            ...
            getValue: function () {
                var f = Ext.getCmp(this.id + '-combo'),
                    c = f.getStore(),
                    a = c.find('field1', f.getValue()),
                    e = this.startDate,
                    b = e.format('D').substring(0, 2).toUpperCase();
                if (a > -1) {
                    switch (a) {
                        case 0:
        ...
        this.until = new Ext.ensible.cal.recurrenceBase({
            ...
            getValue: function () {
                ...
                if (b.isVisible()) {
                    return ';UNTIL=' + b.getValue().format(this.untilDateFormat);
                }
                    ...
                    function (g) {
                        if (g.indexOf('COUNT') > -1) {
                            ...
                            if (g.indexOf('UNTIL') > -1) {
                                ...
                                Ext.getCmp(this.id + '-date')
                                    .setValue(Date.parseDate(e, this.untilDateFormat))
                                    .show();
...
Ext.ensible.cal.DateRangeField = Ext.extend(Ext.form.Field, {
    ...
    onRender: function (e, b) {
        if (!this.el) {
            ...
            if (a == 'auto') {
                var f,
                    c = this.ownerCt.getWidth() - this.ownerCt.getEl().getPadding('lr');
        ...
        Ext.ensible.cal.DateRangeField.superclass.onRender.call(this, e, b);
        if (!a) {
    ...
    getDT: function (c) {
        var b = this[c + 'Time'].getValue(),
            a = this[c + 'Date'].getValue();
        if (Ext.isDate(a)) {
...
Ext.ensible.cal.EventContextMenu = Ext.extend(Ext.menu.Menu, {
    ...
    showForEvent: function (c, a, b) {
        this.rec = c;
        this.ctxEl = a;
        this.dateMenu.picker.setValue(c.data[Ext.ensible.cal.EventMappings.StartDate.name]);
        this.showAt(b);
    },
    onHide: function () {
...
Ext.ensible.cal.CalendarList = Ext.extend(Ext.Panel, {
    ...
    refresh: function () {
        ...
        for (; c < a; c++) {
            g = {
                cmpId: this.id + '__' + e[c].data[b.CalendarId.name],
                title: e[c].data[b.Title.name],
                colorCls: this.getColorCls(e[c].data[b.ColorId.name]),
            };
    ...
    toggleCalendar: function (f, e) {
        var c = this.store.getById(f),
            a = Ext.ensible.cal.CalendarMappings,
            b = c.data[a.IsHidden.name];
    ...
    radioCalendar: function (g) {
        var b = 0,
            f,
            c = Ext.ensible.cal.CalendarMappings.CalendarId.name,
            e = this.store.getRange(),
            a = e.length;
        for (; b < a; b++) {
            f = e[b].data[c];
    ...
    showEventMenu: function (a, b) {
        var f = this.getCalendarId(a.parent('li')),
            e = this.store.getById(f),
            c = e.data[Ext.ensible.cal.CalendarMappings.ColorId.name];
        if (!this.menu) {
...
Ext.ensible.cal.EventEditForm = Ext.extend(Ext.form.FormPanel, {
    ...
    initComponent: function () {
        ...
        this.dateRangeField = new Ext.ensible.cal.DateRangeField({
            ...
            singleLine: false,
            anchor: '90%',
            listeners: {change: this.onDateChange.createDelegate(this)},
        });
        ...
        var a = [this.titleField, this.dateRangeField, this.reminderField],
            b = [this.notesField, this.locationField, this.urlField];
    ...
    loadRecord: function (a) {
        ...
        if (this.recurrenceField) {
            this.recurrenceField.setStartDate(a.data[Ext.ensible.cal.EventMappings.StartDate.name]);
        }
        if (this.calendarStore) {
            this.form.setValues({calendar: a.data[Ext.ensible.cal.EventMappings.CalendarId.name]});
        }
        if (a.phantom) {
    ...
    updateRecord: function () {
        var c = this.dateRangeField.getValue(),
...
Ext.ensible.cal.EventEditWindow = Ext.extend(Ext.Window, {
    ...
    initComponent: function () {
        ...
        if (this.enableEditDetails !== false) {
            this.fbar.unshift({
                xtype: 'tbtext',
                text:
                    '<a href="#" class="' + this.editDetailsLinkClass + '">' + this.detailsLinkText + '</a>',
            });
        }
    ...
    onRender: function (c, a) {
        ...
        Ext.ensible.cal.EventEditWindow.superclass.onRender.call(this, c, a);
    },
    afterRender: function () {
    ...
    show: function (h, g) {
        var c = Ext.isIE8 && Ext.isStrict ? null : g,
            k = Ext.ensible.cal.EventMappings;
        Ext.ensible.cal.EventEditWindow.superclass.show.call(this, c, function () {
            this.titleField.focus(false, 100);
        });
        this.deleteBtn[h.data && h.data[k.EventId.name] ? 'show' : 'hide']();
        var e,
            b = this.formPanel.form;
        if (h.data) {
            e = h;
            if (e.phantom) {
                this.setTitle(this.titleTextAdd);
            ...
            this.setTitle(this.titleTextAdd);
            var i = h[k.StartDate.name],
                a = h[k.EndDate.name] || i.add('h', 1);
            e = new Ext.ensible.cal.EventRecord();
            e.data[k.StartDate.name] = i;
            e.data[k.EndDate.name] = a;
            e.data[k.IsAllDay.name] =
                !!h[k.IsAllDay.name] || i.getDate() != a.clone().add(Date.MILLI, 1).getDate();
            b.reset();
            b.loadRecord(e);
        }
        if (this.calendarStore) {
            this.calendarField.setValue(e.data[k.CalendarId.name]);
        }
    ...
    updateRecord: function (e) {
        var f = this.dateRangeField.getValue(),
            h = Ext.ensible.cal.EventMappings,
            g = this.activeRecord,
    ...
    onSave: function () {
        ...
        this.fireEvent(
            this.activeRecord.phantom ? 'eventadd' : 'eventupdate',
            this,
            this.activeRecord,
            this.animateTarget,
        );
...
Ext.ensible.cal.CalendarView = Ext.extend(Ext.BoxComponent, {
    ...
    getStoreDateParams: function () {
        var a = {};
        a[this.dateParamStart] = this.viewStart.format(this.dateParamFormat);
        a[this.dateParamEnd] = this.viewEnd.format(this.dateParamFormat);
        return a;
    },
    ...
    forceSize: function () {
        if (this.el && this.el.child) {
            var c = this.el.child('.ext-cal-hd-ct'),
                a = this.el.child('.ext-cal-body-ct'),
                b = this.el.parent();
            if (c && a) {
            ...
            for (d = 0; d < this.dayCount; d++) {
                if (b.getCount() > 0) {
                    var a = b.filterBy(function (l) {
                        var k =
                            f.getTime() ==
                            l.data[Ext.ensible.cal.EventMappings.StartDate.name].clearTime(true).getTime();
                        var i = c == 0 && d == 0 && f > l.data[Ext.ensible.cal.EventMappings.StartDate.name];
                        return k || i;
                    }, this);
    ...
    prepareEventGrid: function (c, b, i) {
        var g = this,
            h = 0,
            f = g.viewStart.clone(),
            a = g.maxEventsPerDay || 999,
            e;
        c.each(function (l) {
            var m = Ext.ensible.cal.EventMappings;
            if (Ext.ensible.Date.diffDays(l.data[m.StartDate.name], l.data[m.EndDate.name]) > 0) {
                var k =
                    Ext.ensible.Date.diffDays(
                        Ext.ensible.Date.max(g.viewStart, l.data[m.StartDate.name]),
                        Ext.ensible.Date.min(g.viewEnd, l.data[m.EndDate.name]),
                    ) + 1;
    ...
    onCalendarEndDrag: function (e, a, c) {
        ...
        var b = {},
            c = this.onCalendarEndDragComplete.createDelegate(this, [c]);
    ...
    onUpdate: function (b, c, a) {
        ...
        if (a == Ext.data.Record.COMMIT) {
            ...
            if (this.enableFx && this.enableUpdateFx) {
                this.doUpdateFx(this.getEventEls(c.data[Ext.ensible.cal.EventMappings.EventId.name]), {
                    scope: this,
                });
            }
        }
    ...
    onAdd: function (c, b, a) {
        ...
        if (this.hidden === true || this.monitorStoreEvents === false || e.phantom) {
            return;
        }
        if (e._deleting) {
            delete e._deleting;
        ...
        if (this.enableFx && this.enableAddFx) {
            this.doAddFx(this.getEventEls(e.data[Ext.ensible.cal.EventMappings.EventId.name]), {
                scope: this,
            });
        }
    },
    ...
    onRemove: function (b, c) {
        ...
        if (this.enableFx && this.enableRemoveFx) {
            this.doRemoveFx(this.getEventEls(c.data[Ext.ensible.cal.EventMappings.EventId.name]), {
                remove: true,
                scope: this,
                callback: this.refresh.createDelegate(this, [a]),
            });
        } else {
            this.getEventEls(c.data[Ext.ensible.cal.EventMappings.EventId.name]).remove();
            this.refresh(a);
        }
    },
    ...
    isEventVisible: function (i) {
        ...
        if (b && b.data[Ext.ensible.cal.CalendarMappings.IsHidden.name] === true) {
            return false;
        }
        var a = this.viewStart.getTime(),
            c = this.viewEnd.getTime(),
            k = e[f.StartDate.name].getTime(),
            g = e[f.EndDate.name].getTime();
    ...
    isOverlapping: function (m, l) {
        ...
        var o = Ext.ensible.Date.rangesOverlap(c, g, b, e),
            n = this.minEventDisplayMinutes || 0,
            a = n > 0 && h > -n && h < n;
        return o || a;
    },
    getDayEl: function (a) {
    ...
    setStartDate: function (b, a) {
        ...
        if (
            this.fireEvent('beforedatechange', this, this.startDate, b, this.viewStart, this.viewEnd) !==
            false
        ) {
    ...
    setViewBounds: function (a) {
        ...
        switch (this.weekCount) {
            ...
            case 1:
                this.viewStart =
                    this.dayCount < 7 && !this.startDayIsStatic ? e : e.add(Date.DAY, -c).clearTime(true);
    ...
    getEventRecord: function (b) {
        var a = this.store.find(Ext.ensible.cal.EventMappings.EventId.name, b, 0, false, true);
            ...
            this.editWin = new Ext.ensible.cal.EventEditWindow({
                ...
                listeners: {
                    ...
                    editdetails: {
                        fn: function (c, e, b, a) {
                            c.hide(b);
                            c.currentView.fireEvent('editdetails', c.currentView, e, b);
                        },
                        scope: this,
                    },
                    eventcancel: {
    ...
    moveEvent: function (c, a) {
        if (Ext.ensible.Date.compare(c.data[Ext.ensible.cal.EventMappings.StartDate.name], a) === 0) {
            return;
        }
        if (this.fireEvent('beforeeventmove', this, c, a) !== false) {
            var b = a.getTime() - c.data[Ext.ensible.cal.EventMappings.StartDate.name].getTime();
            c.beginEdit();
            c.set(Ext.ensible.cal.EventMappings.StartDate.name, a);
            c.set(
                Ext.ensible.cal.EventMappings.EndDate.name,
                c.data[Ext.ensible.cal.EventMappings.EndDate.name].add(Date.MILLI, b),
            );
            c.endEdit();
            this.save();
...
Ext.ensible.cal.MonthView = Ext.extend(Ext.ensible.cal.CalendarView, {
    ...
    getEventTemplate: function () {
        if (!this.eventTpl) {
            var b,
                a = this.getEventBodyMarkup();
            b = !(Ext.isIE || Ext.isOpera)
                ? new Ext.XTemplate(
    ...
    getTemplateEventData: function (k) {
        var h = Ext.ensible.cal.EventMappings,
            f = [this.getEventSelectorCls(k[h.EventId.name])],
            g = {},
            b = k[h.RRule.name] != '',
            a = 'x-cal-default',
            i = k[h.Title.name],
            c = Ext.ensible.Date.use24HourTime ? 'G:i ' : 'g:ia ';
        if (this.calendarStore && k[h.CalendarId.name]) {
            var e = this.calendarStore.getById(k[h.CalendarId.name]);
            if (e) {
                a = 'x-cal-' + e.data[Ext.ensible.cal.CalendarMappings.ColorId.name];
            }
        }
        a += k._renderAsAllDay ? '-ad' : '';
        f.push(a);
        if (this.getEventClass) {
            var e = this.getEventRecord(k[h.EventId.name]),
                l = this.getEventClass(e, !!k._renderAsAllDay, g, this.store);
            f.push(l);
        }
        g._extraCls = f.join(' ');
        ...
        g.Title =
            (k[h.IsAllDay.name] ? '' : k[h.StartDate.name].format(c)) +
            (!i || i.length == 0 ? this.defaultEventTitleText : i);
    ...
    getDaySize: function (g) {
        var c = this.el.getBox(),
            f = this.getViewPadding(),
            a = (c.width - f.width) / this.dayCount,
            b = (c.height - f.height) / this.getWeekCount();
        if (g) {
    ...
    getMaxEventsPerDay: function () {
        var b = this.getDaySize(true).height,
            ...
            e = 5,
            a = Math.max(Math.floor((b - c - e) / c), 0);
        return a;
    },
    getViewPadding: function (e) {
        var e = e || 'tlbr',
            ...
            f = e.indexOf('l') > -1,
            b = e.indexOf('r') > -1,
            a = this.showHeader && g ? this.el.select('.ext-cal-hd-days-tbl').first().getHeight() : 0,
            c = 0;
    ...
    getDayAt: function (i, f) {
        var c = this.el.getBox(),
            g = this.getViewPadding('tl'),
            h = this.getDaySize(),
            e = Math.floor((i - c.x - g.width) / h.width),
            b = Math.floor((f - c.y - g.height) / h.height),
            k = b * 7 + e;
        ...
        if (!this.detailPanel) {
            this.detailPanel = new Ext.Panel({
                ...
                items: {
                    ...
                    store: this.store,
                    calendarStore: this.calendarStore,
                    listeners: {eventsrendered: this.onDetailViewUpdated.createDelegate(this)},
                },
            });
            if (this.enableContextMenus && this.readOnly !== true) {
...
Ext.ensible.cal.DayBodyView = Ext.extend(Ext.ensible.cal.CalendarView, {
    ...
    initDD: function () {
        ...
        this.dragZone = new Ext.ensible.cal.DayViewDragZone(
            this.el,
            Ext.apply({containerScroll: true}, a),
        );
        this.dropZone = new Ext.ensible.cal.DayViewDropZone(this.el, a);
    },
    refresh: function (a) {
    ...
    afterRender: function () {
        ...
        var b = Math.max(this.scrollStartHour, this.viewStartHour),
            a = Math.max(0, b - this.viewStartHour);
        if (a > 0) {
    ...
    getEventPositionOffsets: function () {
        return {top: 1, height: -2};
    },
    getTemplateEventBox: function (k) {
        var c = this.hourHeight / this.hourIncrement,
            b = k[Ext.ensible.cal.EventMappings.StartDate.name],
            e = k[Ext.ensible.cal.EventMappings.EndDate.name],
            h = Math.max(b.getHours() - this.viewStartHour, 0),
            i = Math.min(e.getHours() - this.viewStartHour, this.viewEndHour - this.viewStartHour),
            a = h * this.hourIncrement,
            f = i * this.hourIncrement,
            l = e.clearTime(true).add(Date.HOUR, this.viewEndHour),
            g = this.getEventPositionOffsets();
    ...
    renderItems: function () {
        ...
        for (; o < this.dayCount; o++) {
            var t = (emptyCells = skipped = 0),
                u = this.eventGrid[0][o],
                b = u ? u.length : 0,
                g;
            for (; t < b; t++) {
                g = u[t];
                ...
                var s = g.data || g.event.data,
                    e = Ext.ensible.cal.EventMappings,
                    v = s[e.IsAllDay.name] === true,
                    n = Ext.ensible.Date.diffDays(s[e.StartDate.name], s[e.EndDate.name]) > 0,
                    f = v || n;
                if (f) {
                    continue;
                }
                Ext.apply(s, {cls: 'ext-cal-ev', _positioned: true});
                c.push({data: this.getTemplateEventData(s), date: this.viewStart.add(Date.DAY, o)});
            }
        }
        var p = (j = 0),
            q = [],
        ...
        for (; p < k; p++) {
            var g = c[p].data,
                m = null,
                h = g[Ext.ensible.cal.EventMappings.StartDate.name].getDate();
            for (j = 0; j < k; j++) {
                if (p == j) {
                    continue;
                }
        ...
        for (p = 0; p < k; p++) {
            ...
            var r = this.getEventTemplate().apply(g),
                x = this.id + '-day-col-' + c[p].date.format('Ymd');
    ...
    getDayAt: function (o, k) {
        var f = '.ext-cal-body-ct',
            ...
            q = r.getHeight() / this.incrementsPerHour,
            l = k - s.y - q + m.top,
            i = Math.max(0, Math.ceil(l / q)),
            b = i * (this.hourIncrement / this.incrementsPerHour),
            e = this.viewStart.add(Date.DAY, a).add(Date.MINUTE, b).add(Date.HOUR, this.viewStartHour),
            c = this.getDayEl(e),
            g = o;
        if (c) {
            g = c.getLeft();
        ...
        return {
            ...
            timeBox: {
                x: g,
                y: (i * this.hourHeight) / this.incrementsPerHour + s.y - m.top,
                width: n.width,
                height: q,
            },
        };
...
Ext.ensible.cal.WeekView = Ext.extend(Ext.ensible.cal.MultiDayView, {dayCount: 7});
...
Ext.ensible.cal.MonthDayDetailView = Ext.extend(Ext.BoxComponent, {
    ...
    refresh: function () {
        ...
        evts = this.store.queryBy(function (e) {
            var g = this.date.clearTime(true).getTime(),
                k = Ext.ensible.cal.EventMappings,
                i = e.data[k.StartDate.name].clearTime(true).getTime(),
                f = g == i,
                h = false,
                m = e.data[k.CalendarId.name],
                c = this.calendarStore ? this.calendarStore.getById(m) : null;
            if (c && c.data[Ext.ensible.cal.CalendarMappings.IsHidden.name] === true) {
                return false;
            }
            if (!f) {
                var l = e.data[Ext.ensible.cal.EventMappings.EndDate.name].clearTime(true).getTime();
                h = i < g && l >= g;
            }
            return f || h;
        }, this);
        ...
        evts.each(function (c) {
            var e = c.data,
                f = Ext.ensible.cal.EventMappings;
            e._renderAsAllDay =
                e[f.IsAllDay.name] || Ext.ensible.Date.diffDays(e[f.StartDate.name], e[f.EndDate.name]) > 0;
...
Ext.ensible.cal.CalendarPanel = Ext.extend(Ext.Panel, {
    ...
    initComponent: function () {
        ...
        this.viewCount = 0;
        var b = (this.multiDayViewCfg && this.multiDayViewCfg.dayCount) || 3,
            g = (this.multiWeekViewCfg && this.multiWeekViewCfg.weekCount) || 2;
        ...
        if (this.showMultiWeekView) {
            var e = Ext.applyIf(
                {xtype: 'extensible.multiweekview', title: this.getMultiWeekText(g)},
                k,
            );
    ...
    fireViewChange: function () {
        ...
        if (a.getViewBounds) {
            var b = a.getViewBounds(),
                c = {activeDate: a.getStartDate(), viewStart: b.start, viewEnd: b.end};
        }
    ...
    updateNavState: function () {
        ...
        if (e && b.showNavBar !== false) {
            var c = e.id.split(b.id + '-')[1],
                a = Ext.getCmp(b.id + '-tb-' + c);
            if (b.showNavToday) {
